...
export function ChatInput() {
  ...
  return (
    <form
      ...
      className={`w-full max-w-2xl rounded-2xl border-2 border-border bg-gradient-to-bl from-[#1A1A1A] to-[#101010] shadow-2xl shadow-black relative overflow-hidden transition-[min-height] duration-500 ease-in-out ${
